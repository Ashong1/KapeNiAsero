...
<head>
    ...
    <title>Confirm Password | Kape Ni Asero</title>
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css">
    <style>
        :root {
            --primary-coffee: #6F4E37; --dark-coffee: #3E2723; --accent-gold: #C5A065; --input-bg: #F5F5F7;
        }
        body {
...
<div class="glass-card">
    <h3 class="fw-bold text-dark mb-2">Secure Area</h3>
    <p class="text-secondary small mb-4">Please confirm your password to continue.</p>
