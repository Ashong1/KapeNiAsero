...
<div class="container-fluid">
    ...
    <div class="d-flex justify-content-between align-items-center py-2 px-3 bg-white shadow-sm mb-3">
        ...
        <div>
            ...
            @if(Auth::user()->role == 'admin')
                <!-- Added Dashboard Link so you can go back -->
    ...
    <div class="row px-2">
                ...
                <div class="{{ Auth::user()->role == 'admin' ? 'col-md-2 col-4' : 'col-md-3 col-6' }}">
                    ...
                    <div class="card h-100 coffee-card border-0 shadow-sm" 
                        ...
                        <div class="card-body p-2 text-center">
                            ...
                            <!-- ADMIN ONLY: Show Recipe Status & Controls -->
                            @if(Auth::user()->role == 'admin')
                                <hr class="my-2">
                                <div class="d-flex justify-content-between align-items-center px-2">
                                    @if($product->ingredients->isEmpty())
                                        <small class="text-danger" title="No recipe set"><i class="fas fa-exclamation-circle"></i></small>
                                    @else
                                        <small class="text-success" title="Recipe Active"><i class="fas fa-check-circle"></i></small>
                                    @endif
                                    
                                    <div>
                                        <a href="{{ route('products.edit', $product->id) }}" class="btn btn-sm btn-outline-secondary py-0" title="Edit">
        ...
        <!-- RIGHT SIDE: CART (ONLY VISIBLE TO EMPLOYEES) -->
        @if(Auth::user()->role != 'admin')
        <div class="col-md-4">
