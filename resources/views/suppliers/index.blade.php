...
<head>
    ...
    <title>Suppliers | Kape Ni Asero</title>
...
<div class="container">
        ...
        <div class="container-fluid px-1">
            <a class="navbar-brand p-0" href="{{ route('home') }}">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div><div class="brand-title">KAPE NI ASERO</div><div class="brand-subtitle">Supplier Database</div></div>
                </div>
            </a>
            ...
            <div class="collapse navbar-collapse mt-3 mt-lg-0" id="navContent">
                <div class="ms-auto d-flex flex-column flex-lg-row gap-2">
                    <div class="d-flex flex-column flex-lg-row gap-1 bg-light p-1 rounded-4 border border-light">
                        ...
                        <a href="{{ route('categories.index') }}" class="nav-pill-custom"><i class="fas fa-tags fa-sm"></i> Categories</a>
                        <a href="{{ route('suppliers.index') }}" class="nav-pill-custom active"><i class="fas fa-truck fa-sm"></i> Suppliers</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="card card-custom">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-4 fw-bold text-dark">
                            <span class="d-inline-block bg-light rounded p-2 me-2 text-primary-coffee"><i class="fas fa-building"></i></span>
                            {{ $supp->name }}
                        </td>
                        ...
                        <td class="text-end pe-4">
                            <a href="{{ route('suppliers.edit', $supp->id) }}" class="btn btn-sm btn-light text-primary me-1"><i class="fas fa-edit"></i></a>
                            <form action="{{ route('suppliers.destroy', $supp->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Delete supplier?')">
                                @csrf @method('DELETE')
        ...
        @if($suppliers->isEmpty())
            <div class="text-center py-5 text-muted"><p>No suppliers registered.</p></div>
        @endif
    </div>
</div>
